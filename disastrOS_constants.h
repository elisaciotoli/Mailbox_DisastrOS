...
#define MAX_NUM_MESSAGES (MAX_NUM_MAILBOXES*MAX_NUM_MESSAGES_PER_MAILBOX)
#define MAX_NUM_MESSAGES_PER_MAILBOX 128
...
#define DSOS_CALL_SEND  11
#define DSOS_CALL_RECEIVE  12
